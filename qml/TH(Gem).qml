...
<qgis version="2.18.6" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="schluessel">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="gemeinde">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="uebobjekt">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="ueboname">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <customproperties>
    ...
    <property key="labeling/fontSize" value="30"/>
  ...
  <aliases>
    ...
    <alias field="schluessel" index="4" name=""/>
    <alias field="gemeinde" index="5" name=""/>
    <alias field="uebobjekt" index="6" name=""/>
    <alias field="ueboname" index="7" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="960297617">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="schluessel"/>
      <column width="-1" hidden="0" type="field" name="gemeinde"/>
      <column width="-1" hidden="0" type="field" name="uebobjekt"/>
      <column width="-1" hidden="0" type="field" name="ueboname"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="schluessel" expression=""/>
    <default field="gemeinde" expression=""/>
    <default field="uebobjekt" expression=""/>
    <default field="ueboname" expression=""/>
  </defaults>
